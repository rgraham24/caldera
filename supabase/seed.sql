...
-- ===================== POLITICS MARKETS =====================
insert into markets (id, title, slug, description, category, subcategory, creator_id, created_by_user_id, status, close_at, resolve_at, resolved_at, resolution_outcome, rules_text, resolution_source_url, featured_score, trending_score, total_volume, liquidity, yes_price, no_price, yes_pool, no_pool) values
  ('c1000000-0000-0000-0000-000000000041', 'Will Trump fire Jerome Powell before July 2026?', 'trump-fire-powell-2026', 'Resolves YES if Donald Trump fires or forces the resignation of Federal Reserve Chair Jerome Powell before July 31, 2026.', 'politics', 'economy', null, 'a1000000-0000-0000-0000-000000000001', 'open', '2026-07-30T00:00:00Z', '2026-07-31T23:59:00Z', null, null, 'Resolves YES if Donald Trump fires or forces the resignation of Federal Reserve Chair Jerome Powell before July 31, 2026.', 'Official White House statement / major news consensus', 9, 89.4, 1650000, 45000, 0.34, 0.66, 33000, 17000),

  ('c1000000-0000-0000-0000-000000000042', 'Will Trump mention Iran 5+ times at his next press conference?', 'trump-iran-press-conference', 'Resolves YES if Donald Trump says the word Iran 5 or more times during his next scheduled press conference. Q&A counts. Official White House video is the source.', 'politics', 'foreign_policy', null, 'a1000000-0000-0000-0000-000000000001', 'open', '2026-05-01T00:00:00Z', '2026-05-02T00:00:00Z', null, null, 'Resolves YES if Donald Trump says the word Iran 5 or more times during his next scheduled press conference. Q&A counts.', 'Official White House video transcript', 7, 75.2, 320000, 15000, 0.87, 0.13, 6500, 43500),

  ('c1000000-0000-0000-0000-000000000043', 'Will AOC announce a Senate run before end of 2026?', 'aoc-senate-run-2026', 'Resolves YES if Alexandria Ocasio-Cortez officially announces a campaign for US Senate via FEC filing or verified public announcement before December 31, 2026.', 'politics', 'elections', null, 'a1000000-0000-0000-0000-000000000002', 'open', '2026-12-30T00:00:00Z', '2026-12-31T23:59:00Z', null, null, 'Resolves YES if Alexandria Ocasio-Cortez officially announces a campaign for US Senate via FEC filing or verified public announcement.', 'FEC filing / official AOC announcement', 8, 82.6, 980000, 35000, 0.61, 0.39, 19500, 30500),

  ('c1000000-0000-0000-0000-000000000044', 'Will Gavin Newsom announce a 2028 presidential run?', 'newsom-2028-presidential-run', 'Resolves YES if Gavin Newsom publicly announces a 2028 presidential campaign before December 31, 2026.', 'politics', 'elections', null, 'a1000000-0000-0000-0000-000000000002', 'open', '2026-12-30T00:00:00Z', '2026-12-31T23:59:00Z', null, null, 'Resolves YES if Gavin Newsom publicly announces a 2028 presidential campaign before Dec 31, 2026. Official announcement or FEC filing required.', 'Official announcement / FEC filing', 8, 84.1, 1240000, 40000, 0.74, 0.26, 13000, 37000),

  ('c1000000-0000-0000-0000-000000000045', 'Will there be a US-Iran ceasefire before June 2026?', 'us-iran-ceasefire-june-2026', 'Resolves YES if the United States and Iran agree to a formal ceasefire ending active military hostilities before June 30, 2026.', 'politics', 'foreign_policy', null, 'a1000000-0000-0000-0000-000000000001', 'open', '2026-06-29T00:00:00Z', '2026-06-30T00:00:00Z', null, null, 'Resolves YES if the United States and Iran agree to a formal ceasefire ending active military hostilities before June 30, 2026.', 'Official statements from US and Iranian governments', 9, 91.3, 1850000, 50000, 0.52, 0.48, 24000, 26000),

  ('c1000000-0000-0000-0000-000000000046', 'Will Trump approval rating exceed 50% in 2026?', 'trump-approval-50pct-2026', 'Resolves YES if any major polling average (RealClearPolitics or FiveThirtyEight) shows Trump above 50% approval at any point in 2026.', 'politics', 'polls', null, 'a1000000-0000-0000-0000-000000000001', 'open', '2026-12-30T00:00:00Z', '2026-12-31T23:59:00Z', null, null, 'Resolves YES if any major polling average (RealClearPolitics or FiveThirtyEight) shows Trump above 50% approval at any point in 2026.', 'RealClearPolitics polling average', 7, 78.5, 1120000, 38000, 0.38, 0.62, 31000, 19000),

  ('c1000000-0000-0000-0000-000000000047', 'Will JD Vance run for President in 2028?', 'jd-vance-president-2028', 'Resolves YES if JD Vance officially announces a 2028 presidential campaign before December 31, 2026.', 'politics', 'elections', null, 'a1000000-0000-0000-0000-000000000002', 'open', '2026-12-30T00:00:00Z', '2026-12-31T23:59:00Z', null, null, 'Resolves YES if JD Vance officially announces a 2028 presidential campaign before Dec 31, 2026. Official announcement or FEC filing required.', 'Official announcement / FEC filing', 7, 77.3, 850000, 30000, 0.55, 0.45, 22500, 27500),

  ('c1000000-0000-0000-0000-000000000048', 'Will the US enter a recession in 2026?', 'us-recession-2026', 'Resolves YES if the National Bureau of Economic Research (NBER) officially declares a US recession that begins in 2026.', 'politics', 'economy', null, 'a1000000-0000-0000-0000-000000000001', 'open', '2026-12-30T00:00:00Z', '2027-06-30T23:59:00Z', null, null, 'Resolves YES if the National Bureau of Economic Research (NBER) officially declares a US recession that begins in 2026.', 'NBER official recession declaration', 9, 92.7, 2100000, 55000, 0.44, 0.56, 28000, 22000),

  ('c1000000-0000-0000-0000-000000000049', 'Will Tucker Carlson interview Putin again in 2026?', 'tucker-carlson-putin-2026', 'Resolves YES if Tucker Carlson conducts and publishes a new interview with Vladimir Putin in 2026.', 'politics', 'media', null, 'a1000000-0000-0000-0000-000000000003', 'open', '2026-12-30T00:00:00Z', '2026-12-31T23:59:00Z', null, null, 'Resolves YES if Tucker Carlson conducts and publishes a new interview with Vladimir Putin in 2026.', 'Tucker Carlson Network official release', 6, 71.8, 680000, 25000, 0.29, 0.71, 35500, 14500);
