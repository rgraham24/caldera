/**
 * CHARACTERIZATION TESTS for lib/fees/calculator.ts
 *
 * These tests document what the calculator does TODAY (pre-rewrite).
 * They exist to catch behavior changes during the tokenomics-v2 rewrite.
 *
 * After the rewrite, most of these tests should FAIL — that's the signal
 * that the rewrite actually changed behavior as intended. We'll then
 * update them (or replace them with tests for the new model) in the
 * corresponding rewrite commit.
 *
 * DO NOT edit this file to "fix" failures — failures are expected and
 * meaningful.
 */
...
describe('calculateMarketFees: fee rates', () => {
...
describe('calculateMarketFees: claimed creator routing', () => {
...
describe('calculateMarketFees: unverified creator routing', () => {
...
describe('calculateMarketFees: active_verified creator routing', () => {
...
describe('calculateMarketFees: multi-tier routing', () => {
...
describe('calculateFees (legacy wrapper): always routes to community', () => {
