      ...
      >
        ...
        <div className="flex gap-2 mt-3 pt-3 border-t border-white/5">
          <button
            ...
            className="flex-1 min-h-[44px] py-2 rounded-lg text-xs font-semibold tabular-nums bg-emerald-500/10 hover:bg-emerald-500/20 text-emerald-400 border border-emerald-500/20 hover:border-emerald-500/40 transition-all duration-150 active:scale-[0.98]"
          >
            YES {yesPercent}¢
          </button>
          <button
            ...
            className="flex-1 min-h-[44px] py-2 rounded-lg text-xs font-semibold tabular-nums bg-red-500/10 hover:bg-red-500/20 text-red-400 border border-red-500/20 hover:border-red-500/40 transition-all duration-150 active:scale-[0.98]"
          >
            NO {100 - yesPercent}¢
          </button>
        </div>
