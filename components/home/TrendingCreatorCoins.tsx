      ...
      <div className="flex gap-4 overflow-x-auto pb-2 scrollbar-hide">
        {creators.map((creator) => {
          ...
          return (
            <div
              key={creator.id}
              className="min-w-[240px] flex-shrink-0 rounded-2xl border border-border-subtle bg-surface p-5 transition-all duration-200 ease-out hover:-translate-y-0.5 hover:border-caldera/20 hover:shadow-lg hover:shadow-caldera/10"
            >
