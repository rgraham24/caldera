          ...
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
            {creators.map((c) => {
              ...
              return (
                <div
                  key={c.id}
                  className="flex flex-col rounded-2xl border border-border-subtle bg-surface p-5 transition-all duration-200 ease-out hover:-translate-y-0.5 hover:border-caldera/20 hover:shadow-lg hover:shadow-caldera/10"
                >
